    ...
    return (
        <div>
            <nav className="navbar navbar-expand-sm menu-sectoring justify-content-between">
                ...
                <div className="navbar-collapse collapse menu-left-style" id="collapseMenu">
                    <ul className="nav col-lg-6 col-md-7 col-sm-auto col-xs-6">
                        <li className="nav-item active">
                            <a className="nav-link"> <strong>User Pages</strong></a>
                        </li>
            ...
            <nav
                className="navbar navbar-expand-lg submenu-style submenu-sectoring bg-light"
            >
                <button
                ...
                >
                    ...
                    <ul
                        className="navbar-nav col-xl-6 col-lg-7 submenu bg-light justify-content-end"
                    >
                        <li className="nav-item">
                            <div>
                                <img
