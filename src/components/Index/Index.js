      ...
      <div className="content-sectoring">
        <div className="row justify-content-between">
              ...
              <div className="comment">
                ...
                <div className="comment-content">
                  <div>
                    ...
                    without it is like a sunless garden when the flowers are
                    dead. Because summer is passion, memories, light breeze, the
                    sun that appears on the skin and caresses the face.
                  </div>
                ...
                <div className="content-block-style collapse-post">
                      ...
                      <div className="row justify-content-end">
                        ...
                        <div className="col-lg-1 col-md-1 col-sm-1 col-1">
                          <a
                            ...
                            className={
                              show1 == true ? 'arrow-up' : 'arrow-down'
                            }
                          ></a>
                        </div>
                      </div>
                  ...
                  >
                    <div>
                      ...
                      Sint, porro sunt sapiente ea non et quasi tempora
                      distinctio ad cum, magnam labore nam harum facilis
                      praesentium ratione minima quos explicabo, deserunt nihil
                      unde ab laudantium. Assumenda, ullam distinctio? Expedita
                      saepe necessitatibus est quidem nisi ex iure beatae, eaque
                      animi, ut distinctio dicta nam unde itaque possimus sed
                      blanditiis perspiciatis atque fugit voluptas optio
                      aperiam? Nisi harum corrupti sequi?
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="col-lg-2 content-right-sectoring">
            <div className="row avatar content-block-style text-center justify-content-center">
              <div>
